...
export PEER1_ORG1_CA=$NW_PATH/peerOrganizations/org1.${NW_NAME}.com/peers/peer1.org1.${NW_NAME}.com/tls/ca.crt
export PEER1_ORG2_CA=$NW_PATH/peerOrganizations/org2.${NW_NAME}.com/peers/peer1.org2.${NW_NAME}.com/tls/ca.crt
